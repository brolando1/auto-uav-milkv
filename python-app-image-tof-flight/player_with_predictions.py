...
def _ensure_sys_path_for_models() -> None:
    """
    player.py si trova in training_quantization/.
    GateClassifier è atteso in training_quantization/models/.
    """
...
def main() -> None:
    ...
    ap.add_argument("--save_dir", type=str, default="./training_quantization/retraining_data/retraining21")
