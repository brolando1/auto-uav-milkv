...
"""
Double convolutional block used in GateNaviagtor and GateClassifier class
"""
...
"""
GateNavigator network using camera + tof as input and outputting yaw rate prediction as a regression task
"""
class GateNavigator(nn.Module):
    def __init__(self, num_channels_start=4, dropout_p=0.0):
        super(GateNavigator, self).__init__()
