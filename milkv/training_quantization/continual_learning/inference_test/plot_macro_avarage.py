...
CSV_FILES = {
    ...
    "gate+coll5": "coll5.csv",
    "gate+coll6": "coll6.csv",
    "gate+coll7": "coll7.csv",
    "gate+coll8": "coll8.csv",
    "gate+coll9": "coll9.csv",
}
...
def main():
    ...
    ax.set_title("Macro average score")
